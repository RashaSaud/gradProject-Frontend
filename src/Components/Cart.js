...
return (
  menu.length ? 
  <div class="cart_section" id="Cart" >
      ...
      <div class="row">
                ...
                return(
                  ...
                  <ul class="cart_list">
                      <li class="cart_item clearfix">
                          <div class="cart_item_image"><img  src={element.itemId.FoodImg} alt=""/></div>
                          <div class="cart_item_info d-flex flex-md-row flex-column justify-content-between">
                              <div class="cart_item_name cart_info_col">
                                  <div class="cart_item_title">Name</div>
                                  <div class="cart_item_text">{element.itemId.Foodname}</div>
                              </div>
        ...
        <span className="qt-plus"  onClick={() => {Test(element.itemId._id)}} >+</span>
                              ...
                              <div class="cart_item_price cart_info_col">
                                  ...
                                  <div class="cart_item_text"> SR: {element.itemId.FoodPrice}</div>
                              </div>
                              <div class="cart_item_price cart_info_col">
                                  <div class="cart_item_title">remove product</div>
                                  <div class="cart_item_text"><button  className="removeBtn" onClick={() => {deleteAllItem(element.itemId._id)}}><FcCancel/></button> </div>
                              </div>
                          </div>
                      </li>
                  </ul>
                  ...
                  <div class="order_total">
                      <div class="order_total_content text-md-right">
                          ...
                          <div class="order_total_amount">    {menu.reduce((total, item)=>total+(item.itemId.FoodPrice*item.quantity),0)}SR</div>
                      </div>
                  </div>
                  {enterTopay===false?
                  <div class="cart_buttons"> 

                  <button type="button" class="w3-bar-item w3-button w3-yellow" onClick={() => {T()}}>Click to pay</button> </div>
         :""}
                  </div>
